package automation_framework.selenium_framework;
...
public class StandAloneTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("atulchavan@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Google123$");
